...
<p align="center">
  <a href="https://github.com/Junkz3/wrench-board/stargazers"><img src="https://img.shields.io/github/stars/Junkz3/wrench-board?style=flat&color=63d1de" alt="GitHub stars"></a>
  <img src="https://img.shields.io/badge/python-3.11+-blue" alt="Python 3.11+">
  <img src="https://img.shields.io/badge/license-source--available-lightgrey" alt="License: source-available">
  <img src="https://img.shields.io/badge/powered%20by-Claude%20Opus%204.8-d97757" alt="Powered by Claude Opus 4.8">
</p>

> Agent-native diagnostic workbench for board-level electronics repair,
> powered by Claude Opus 4.8. **Right-to-repair, built in the open, by the
...
Opus 4.8 diagnostic agent that pilots the board visually (highlights
pins, traces nets, simulates failures) while the technician keeps the
iron in their hand.

It is device-agnostic. Feed it a schematic and a boardview and it works
the same on iPhone and MacBook logic boards, Android and Samsung phones,
game console motherboards, laptops, and single-board computers. Anything
with a schematic and a boardview is fair game.
...
- **Schematic Ingestion**: Opus 4.8 vision compiles a PDF schematic, page
...
- **Diagnostic Agent**: an Anthropic Managed Agent per device, with a
  ...
  `device-{slug}`, `repair-{repair_id}`), pilots the boardview through 17
  `bv_*` tools and queries the pack, schematic graph, measurements,
  validations and technician profile through 27 more: 44 custom tools
...
- **Frontend**: vanilla HTML + CSS + JS, OKLCH design tokens, D3 v7 for the
  knowledge graph and Three.js r128 (WebGL) for the boardview. Inline SVG
  icons. No framework.
- **Models**: Claude Opus 4.8 (heavy pipeline writers, schematic vision,
...
- **Boardview**: 16 parsers in `api/board/parser/`, dispatched
...
- **Tests**: 2 600+ fast tests (~1 min) plus a `@slow` accuracy-gate suite,
...
on your Anthropic account (1 environment + 3 tier-scoped agents, idle,
