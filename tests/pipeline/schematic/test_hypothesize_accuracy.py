...
# Note (Phase 4, 2026-04-24): `shorted` thresholds dropped by ~5 pts
# after SimulationEngine._cascade started iterating to fixpoint (commit
# message below has details). PENALTY_WEIGHTS will be re-tuned and
...
THRESHOLDS: dict[str, dict[str, float]] = {
    ...
    "shorted":   {"top1": 0.15, "top3": 0.30, "mrr": 0.22},  # fixpoint widened cascades → thresholds lowered; will re-anchor after corpus regen.
